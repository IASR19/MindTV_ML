import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QTabWidget, QWidget, QVBoxLayout, QLabel, QComboBox, QPushButton, QTextEdit, QSpinBox, QFileDialog, QProgressBar, QDialog
...
class MainApp(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle('MindTV - Aplicação Completa')
        self.setGeometry(100, 100, 800, 600)

        self.tab_widget = QTabWidget(self)
        self.setCentralWidget(self.tab_widget)

        self.coleta_inicial_tab = ColetaInicial()
        self.treinamento_rede_tab = TreinamentoRede()
        self.mindtv_app_tab = MindTVApp()

        self.tab_widget.addTab(self.coleta_inicial_tab, "Coleta Inicial")
        self.tab_widget.addTab(self.treinamento_rede_tab, "Treinamento da Rede")
        self.tab_widget.addTab(self.mindtv_app_tab, "MindTV App")
